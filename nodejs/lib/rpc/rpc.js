...
function rpc(opt) {
    ...
    this.__results_queue_name_type = opt.type || 'callback';
    this.__results_cb = {};
...
rpc.prototype._makeResultsQueue = function(cb) {
    ...
    this.__results_queue_name = this.generateQueueName(this.__results_queue_name_type);
    this.__make_results_cb.push(cb);
            ...
            $this._makeExchange(function() {
                $this._makeResultsQueue(function() {
                    ...
                    $this.__results_cb[corr_id] = {
                        cb: cb,
                        context: context,
                        autoDeleteCallback: options.autoDeleteCallback === undefined ? true : options.autoDeleteCallback,
