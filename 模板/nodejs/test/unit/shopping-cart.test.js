...
describe('/shopping-cart', function () {
    ...
    it('DELETE /', function (done) {
        ...
        var path = '/shopping-cart/items?insuranceNum=' + insuranceSlipsId;
    ...
    it('DELETE /items/all without login', function (done) {
        var path = '/shopping-cart/items/all';
    ...
    it('GET /items/count', function (done) {
        var path = '/shopping-cart/items/count';
