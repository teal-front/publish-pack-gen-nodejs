...
var InsuranceSlipsService = require('../services/insurance-slips-service');
...
router.get('/:id', function (req, res, next) {
    ...
    InsuranceSlipsService.queryById(id)
        .then(sendResponse)
        .catch(handleError);
});
...
router.get('/:id/page-info', function(req, res, next) {
    ...
    var fetchInsuranceSlips = function (insuranceSlipsId) {
        return InsuranceSlipsService.queryById(insuranceSlipsId)
    ...
    var fetchPageData = function(params) {
        return new Promise(function(resolve, reject) {
    ...
    fetchInsuranceSlips(insuranceSlipsId)
        .then(fetchPageData)
        .then(sendResponse)
        .catch(handleError);
});
